...
# index.hbs
tagline =  让每个人都能构建出{ $linebreak }可靠而高效的软件。
get-started = 入 门
...
language-values-reliability-blurb = Rust 丰富的类型系统和所有权模型保证了内存安全和线程安全&mdash;&mdash;您能够在编译期消除多种错误。
...
domains-blurb = 2018 年，Rust 社区决定在一些不同的领域中提升编程体验
          （参见 <a href="https://blog.rust-lang.org/2018/03/12/roadmap.html">2018 年路线图</a>）。
          对此，您可以找到许多高质量的 crate 和一些精彩的入门指南。
domains-learn-more = 了解更多

domains-cli = 命令行
domains-cli-blurb = 使用 Rust 强大的生态系统快速实现 CLI 工具。Rust 可助您放心维护，轻松分发应用程序。
domains-cli-alt = 终端
...
get-involved-read-rust = 阅读 Rust 文档
