...
governance-rfc-blurb = Rust 中的每个重要决定都是从征求评议意见书（RFC）开始。
          邀请每个人讨论该提案，从而达成共识和做出权衡。
          虽然有时候很消耗精力，但这个社区审议是Rust 高质量的强力保障。
governance-roadmap-blurb = RFC 流程还用来制定年度路线图，阐明我们对该年度的期望。
          这一共同愿景对于确保开发流程的重点至关重要。
governance-roadmap-read = 阅读 2018 路线图
...
governance-team-discord = Discord 频道 { $channel }
governance-user-github = GitHub: { $link }
governance-user-team-leader = 团队领导者
