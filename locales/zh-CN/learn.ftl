...
learn-book = <cite>《Rust 程序设计语言》</cite>被亲切地称为“圣经”。本书从基本原则出发，给出了 Rust 语言的概览。您会在阅读本书时构建一些项目。在读完本书后，您将会坚实地掌握 Rust 语言。
...
learn-rbe = 如果您不喜欢通过阅读大量的文档来学习语言，那么《通过例子学 Rust》就能涵盖您要学的知识。虽然本书花了很多篇幅来解释代码，但它展示的代码很丰富，并且尽量减少了文字解释。它还包括很多练习！
...
learn-play = 您可以在 Rust 练习场上在线试用 Rust，而无需在您的计算机上安装任何东西。
...
learn-install-cargo = <p>您在安装 Rustup 时，也会安装 Rust 构建工具和包管理器的最新稳定版，即 Cargo。Cargo 可以做很多事情：</p>
                        <ul>
                        ...
                        <p>要测试您是否安装了 Rust 和 Cargo，您可以在您的终端中运行：</p>
...
learn-generating-steps = <p>我们在新的 Rust 开发环境中编写一个小应用。首先，我们用 Cargo 创建一个新项目。在您的终端中执行：</p>
...
learn-dependencies-steps = <p>我们来为应用添加依赖。您可以在 <a href="https://crates.io">crates.io</a>，即 Rust 包的仓库中找到所有类别的库。在 Rust 中，我们通常把包称作“crates”。</p>
...
learn-read-docs = 您已经是一名 Rustacean 了！欢迎！我们很高兴您的加入！当您准备好后，跳到学习页面，您可以在那里找到大量的文档，它们帮助您继续您的 Rust 旅程。
...
learn-ferris = <p>Ferris 是 Rust 社区的非官方吉祥物。很多 Rust 程序员自称“Rustaceans”，玩了个“<a href="https://en.wikipedia.org/wiki/Crustacean">crustacean</a>”的文字游戏。我们用 “they,” “them,” 等代词来指代 Ferris，而不用带性别的代词。</p>
               ...
               <p>您可以在 <a href="http://rustacean.net/">http://rustacean.net/</a> 上找到更多 Ferris 的图片。
