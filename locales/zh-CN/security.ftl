...
security-reporting-description =
        ...
        <p>该电子邮箱经常大量的垃圾邮件，因此，请务必使用描述性的主题，以避免我们错过您的报告。在初步回复您的报告后，安全团队会及时通知您该漏洞的修复进展。根据 <a href="{ -wikipedia-rfpolicy-href }">RFPolicy</a> 的建议，这些更新应至少每五天发送一次。实际上，更有可能每 24～48 小时发送一次。</p>
